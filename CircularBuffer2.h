 ...
 */
#ifndef MBED_CIRCULARBUFFER2_H
#define MBED_CIRCULARBUFFER2_H
...
public:
    CircularBuffer2(T *pool, size_t buffer_size) : _pool(pool), BufferSize(buffer_size), _head(0), _tail(0), _full(false)
    {
    }
